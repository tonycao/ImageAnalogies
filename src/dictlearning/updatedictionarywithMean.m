function [matDictionary] = updatedictionarywithMean(vecPatches, matDictionary, alphas, param)
...
matDictionary = matDictionary./repmat(sqrt(sum(matDictionary(1:bb^2, :).^2)), size(matDictionary,1),1);
